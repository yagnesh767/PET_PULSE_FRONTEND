...
class SymptomCheckerQ2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_symptom_checker_q2, container, false)
        ...
        nextButton.setOnClickListener {
            val fragment = SymptomCheckerQ3Fragment()
            val bundle = Bundle()
            bundle.putInt("q1_answer", q1Answer)
            bundle.putInt("q2_answer", selectedOption)
