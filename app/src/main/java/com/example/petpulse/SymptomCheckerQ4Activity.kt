...
class SymptomCheckerQ4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_symptom_checker_q4)

        q1Answer = intent.getIntExtra("q1_answer", -1)
        q2Answer = intent.getIntExtra("q2_answer", -1)
        q3Answer = intent.getIntExtra("q3_answer", -1)
