...
class SymptomCheckerQ4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_symptom_checker_q4, container, false)

        arguments?.let {
            q1Answer = it.getInt("q1_answer", -1)
            q2Answer = it.getInt("q2_answer", -1)
            q3Answer = it.getInt("q3_answer", -1)
        }
        ...
        nextButton.setOnClickListener {
            val fragment = SymptomAnalysisFragment()
            val bundle = Bundle()
            bundle.putInt("q1_answer", q1Answer)
            bundle.putInt("q2_answer", q2Answer)
            bundle.putInt("q3_answer", q3Answer)
            bundle.putInt("q4_answer", selectedOption)
