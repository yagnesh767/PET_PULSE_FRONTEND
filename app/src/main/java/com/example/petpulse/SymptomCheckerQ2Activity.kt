...
class SymptomCheckerQ2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_symptom_checker_q2)
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, SymptomCheckerQ3Activity::class.java)
            intent.putExtra("q1_answer", q1Answer)
            intent.putExtra("q2_answer", selectedOption)
